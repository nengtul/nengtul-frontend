                ...
                <InputPart>
                    ...
                    <InputArea id="Password">
                        ...
                        <InputWrapper>
                            ...
                            {password.length > 0 && 
                            (ispassword?
                             (<div style={{color:'white', fontSize:'14rem'}}> 안전한 비밀번호에요 :) </div>)
                            :(<div style={{color:'red' , fontSize:'14rem'}}>  8자리 이상의 비밀번호를 입력해주세요 </div>)
                            )}
                            </Message>
                        </InputWrapper>
                    </InputArea>
                    <InputArea id="PasswordCheck">
                        ...
                        <InputWrapper>
                            ...
                            {passwordCheck.length > 0 && 
                              (ispasswordcheck?
                              (<div style={{color:'white', fontSize:'14rem'}}> 비밀번호를 똑같이 입력했어요 : ) </div>)
                              :(<div style={{color:'red', fontSize:'14rem'}}>  비밀번호가 틀려요. 다시 확인해주세요 ㅜ ㅜ </div>)
                              )
                            }
                            </Message>
                        </InputWrapper>
